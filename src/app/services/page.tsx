  ...
  return (
    <>
      ...
      <div className='lg:block hidden'>
          <Image src={service_image_2} width={550} height={200} alt='Image' className='rounded-3xl overflow-hidden max-h-xl' />
        </div>
        <div className=' text-black mt-16 space-y-6'>
          ...
          <button className='py-2 px-5 underline rounded-3xl border-[#054378] text-gray-600'>Learn More</button>
        </div>
