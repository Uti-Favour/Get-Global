        ...
        <>
            <div className='bg-blue-700 lg:p-5 p-3 mt-20'>
                <div className='text-black mt-10'>
                    <motion.h1 className='flex justify-center text-center font-bold text-4xl lg:text-7xl text-white'>Our mobile app launch is on the way...</motion.h1>
                ...
                <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 20 }} transition={{ duration: 5 }} className='lg:flex justify-center mt-16'>
