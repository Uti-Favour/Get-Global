  ...
  return (
    ...
    <div className='lg:flex lg:mx-20 mx-5 mt-10'>
        <div className='mt-20'>
          ...
          <h1 className='text-black lg:text-7xl text-4xl font-medium lg:max-w-[80%]'>Discover Your Next Great Adventure <i className="fa-solid fa-plane-departure"></i></h1>
            ...
            <div className='text-black space-x-4 text-center lg:flex-row flex-col flex'>
                <Link href={'google.com'} className='py-3 px-10 bg-black text-white rounded-3xl'>Book Consultation <i className="fa-solid fa-arrow-right-long ml-1"></i>

                </Link>      
                <Link href={'google.com'} className='py-3 px-10 bg-[#F1F2F4] text-black rounded-3xl lg:block hidden'>View Features</Link>
            </div>
          </div>
            <div className='flex space-x-6 text-black lg:mt-28 mt-20'>
                <div>
                    <h2 className='font-medium text-4xl'>50+</h2>
                    <p className='text-black max-w-48'>Multinational Business have used Get Global</p>
                </div>
                <div>
                    <h2 className='font-medium text-4xl'>100+</h2>
                    <p className='text-black max-w-48'>Lorem ipsum dolor sit amet consectetur uno.</p>
                </div>
            </div>
        </div>
